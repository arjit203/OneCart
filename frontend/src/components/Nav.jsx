...
function Nav() {
  ...
  return (
    <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black '>
        ...
        <div className='w-[100vw] h-[90px] flex items-center justify-between  text-[12px] fixed px-[20px] bottom-0 left-0 bg-[#191818] md:hidden'>
        ...
        <button className='text-[white] flex items-center justify-center flex-col gap-[2px]' onClick={()=>navigate("/cart")}><MdOutlineShoppingCart className='w-[28px] h-[28px] text-white md:hidden' onClick={()=>navigate('/cart')}/>Cart</button> 
        <p className='absolute w-[18px] h-[18px] items-center  justify-center bg-black px-[5px] py-[2px] text-white rounded-full text-[9px] top-[8px] right-[18px]'>{getCartCount()}</p>  
