...
function Collections() {
    ...
    let [sortType,setSortType] = useState("revelent")
  ...
  return (
    <div className='w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start flex-col md:flex-row justify-start pt-[70px] overflow-x-hidden z-[2] pb-[110px]'>
        ...
        <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh]${showFilter ? "h-[15vh]": "h-[8vh]"} p-[20px] border-r-[1px] border-gray-400 text-[#aaf5fa] lg:fixed`}>

            <p className='text-[25px] font-semibold flex gap-[5px] cursor-pointer items-center justify-start ' onClick={()=>setShowFilter(prev=>!prev)}>FILTERS
            ...
            <div className='w-[230px] h-[120px] flex items-start justify-center gap-[10px] flex-col'>
                <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'><input type="checkbox" value={'TopWear'} className='w-3 cursor-pointer'onChange={toggleSubCategory}/>TopWear</p>
                <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'><input type="checkbox" value={'BottomWear'} className='w-3 cursor-pointer'onChange={toggleSubCategory}/>BottomWear</p>
                <p className='flex items-center justify-center gap-[10px] text-[16px] font-light'><input type="checkbox" value={'WinterWear'} className='w-3 cursor-pointer' onChange={toggleSubCategory}/>WinterWear</p>
            </div>
        ...
        <div className='lg:pl-[20%] md:py-[10px] '>
            <div className='md:w-[80vw] w-[100vw] p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]'>
                ...
                <select name="" id="" className='bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-white rounded-lg hover:border-[#46d1f7] border-[2px] outline-0 cursor-pointer' onChange={(e)=>setSortType(e.target.value)}>
                    <option value="relevent" className='w-[100%] h-[100%]'>Short By: Relevent</option>
