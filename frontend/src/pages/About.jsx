    ...
    <div className="w-full min-h-[100vh] flex items-center justify-center flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] gap-[50px] pt-[80px] overflow-x-hidden">
      ...
      <div className='w-[100%] flex items-center justify-center flex-col lg:flex-row'>
        ...
        <div className='lg:w-[50%] w-[80%] flex items-start justify-center gap-[20px] flex-col mt-[20px] lg:mt-[0px]'>
          ...
          OneCart born for smart, seamless shopping—created to deliver quality products, trending styles, and everyday essentials in one place. With reliable service, fast delivery, and great value, OneCart makes your online shopping experience simple, satisfying, and stress-free. </p>
          ...
          <p className='lg:w-[80%] w-[100%] text-white  text-[15px] lg:text-[18px] mt-[10px] font-bold'>OUR MISSION </p>
