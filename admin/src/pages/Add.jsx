...
function Add() {
  ...
  return (
    <div className='w-[100vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white overflow-x-hidden relative'>
      ...
      <Nav/>
      <Sidebar/>
      <div className='w-[82%] h-[100%] flex items-center justify-start overflow-x-hidden absolute right-0 lg:top-[20px]  bottom-[5%]'>
        <form action="" onSubmit={handleAddProduct} className='w-[100%] md:w-[90%] mt-[120px] h-[100%]  md:mt-[70px] flex flex-col gap-[30px] py-[60px] px-[30px] md:px-[60px]'>
          <div className='w-[400px] h-[50px] text-[25px] md:text-[40px] text-white'>Add Product Page</div>
          <div className='w-[80%] h-[130px] flex items-start justify-center flex-col mt-[20px] gap-[10px]'><p className='text-[20px] md:text-[25px] font-semibold'>Upload Images</p>
          <div className='w-[100%] h-[100%] flex items-center justify-start'>
            ...
            <label htmlFor="image1" className=' w-[65px] h-[65px] md:w-[100px] md:h-[100px] cursor-pointer hover:border-[#46d1f7]'>
              ...
              <input type="file" name="" id="image1" hidden onChange={(e)=>setImage1(e.target.files[0])} required />
            </label>
              ...
              <input type="file" name="" id="image2" hidden onChange={(e)=>setImage2(e.target.files[0])} required/>
            </label>
              ...
              <input type="file" name="" id="image3" hidden onChange={(e)=>setImage3(e.target.files[0])} required/>
            </label>
              ...
              <input type="file" name="" id="image4" hidden onChange={(e)=>setImage4(e.target.files[0])} required/>
            </label>
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] '>
            ...
            <input type="text" name="" placeholder='Type Here'  className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2] outline-none' onChange={(e)=>setName(e.target.value)} value={name} required/>
          </div>

            <div className='w-[80%] flex items-start justify-center flex-col gap-[10px] '>
            <p className='text-[20px] md:text-[25px] font-semibold'>Product Description</p>
            <textarea type="text" name="" placeholder='Type Here'  className='w-[600px] max-w-[98%] h-[100px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] py-[10px] text-[18px] placeholder:text-[#ffffffc2] outline-none' onChange={(e)=>setDescription(e.target.value)} value={description} required/>
          </div>
          ...
          <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
              <p className='text-[20px] md:text-[25px] font-semibold w-[100%]' >Product Category</p>
                <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px] outline-0' onChange={(e)=>setCategory(e.target.value)} value={category} >
            ...
            <div className='md:w-[30%] w-[100%] flex items-start sm:justify-center flex-col gap-[10px]'>
              <p className='text-[20px] md:text-[25px] font-semibold w-[100%]' >Sub-Category   </p>
                <select name="" id="" className='bg-slate-600 w-[60%] px-[10px] py-[7px] rounded-lg hover:border-[#46d1f7] border-[2px] outline-0' onChange={(e)=>setSubCategory(e.target.value)} value={subCategory}>
          ...
          <div className='w-[80%] h-[100px] flex items-start justify-center flex-col gap-[10px] '>
            ...
            <input type="number" name="" placeholder='₹ 2000'  className='w-[600px] max-w-[98%] h-[40px] rounded-lg hover:border-[#46d1f7] border-[2px] cursor-pointer bg-slate-600 px-[20px] text-[18px] placeholder:text-[#ffffffc2] outline-none' onChange={(e)=>setPrice(e.target.value)} value={price} required/>
          </div>
          ...
          <div className='w-[80%] flex items-center justify-start gap-[10px] mt-[20px] '>
            <input type="checkbox" className='w-[25px] h-[25px] cursor-pointer' onChange={()=>setBestSeller(prev => !prev)}/>
            <label htmlFor="checkbox" className='text-[18px] md:text-[22px] font-semibold'>
              Add To BestSeller
            </label>
          </div>
          <button className='w-[140px] px-[18px] py-[18px] rounded-xl text-black flex items-center justify-center bg-[#65d8f7] gap-[10px] active:bg-slate-700 active:text-white active:border-[2px]'>{loading ? <Loading/> : "Add Product"}</button>
        </form>
      </div>
    </div>
  )
